...
function(cxx_binary)
    ...
    add_executable("${add_target_args_TARGET}"
            "${add_target_args_FILENAME}" "${add_target_args_FILENAMES}")
...
function(cxx_test)
    ...
    # Add the following lines to print the link libraries property
    get_target_property(TEST_LINK_LIBRARIES ${add_target_args_TARGET} LINK_LIBRARIES)
    message(STATUS "${add_target_args_TARGET} link libraries: ${TEST_LINK_LIBRARIES}")
endfunction()
